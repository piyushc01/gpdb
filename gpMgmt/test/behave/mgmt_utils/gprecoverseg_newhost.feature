...
# The @concourse_cluster tag denotes the scenario that requires a remote cluster
    ...
    Scenario: failed host is not in reach gprecoverseg recovery works well
        ...
        Then the user runs command "echo 'sdw2|20000| /data/gpdata/primary/gpseg2 sdw5|20002| /data/gpdata/primary/gpseg2' >> /tmp/test-gprecoverseg01-scheraio-config-file"
