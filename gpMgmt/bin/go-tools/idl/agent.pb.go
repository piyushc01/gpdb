...
type ValidateHostEnvRequest struct {
	...
	SocketAddressList    []string `protobuf:"bytes,3,rep,name=socketAddressList,proto3" json:"socketAddressList,omitempty"`
...
func (m *ValidateHostEnvRequest) GetSocketAddressList() []string {
	if m != nil {
		return m.SocketAddressList
	}
	return nil
}
...
var fileDescriptor_56ede974c0020f77 = []byte{
	...
	,
}
